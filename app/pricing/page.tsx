            ...
            <div className="mt-16 flex justify-center">
              <div className="relative rounded-2xl border border-white/10 bg-black/50 backdrop-blur-sm p-8 md:p-12 max-w-lg w-full shadow-2xl">
                ...
                <div className="text-center space-y-4 mb-8">
                  ...
                  <p className="text-sm text-muted-foreground">Because this is a v0 template!</p>
                </div>
            ...
            <div className="space-y-8">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Yes! V-Grid is a template generated by v0 and is completely free to use in your personal and
                  commercial projects.
                </p>
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Since this is a template, support is community-driven. You can check the documentation or open issues
                  on GitHub.
                </p>
              </div>
            </div>
