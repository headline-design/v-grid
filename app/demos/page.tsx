  ...
  const demos = [
    {
      id: "performance",
      label: "Performance",
      description: "Grid performance with adjustable rows and columns",
      image: "/images/performance-demo.jpg",
    },
    {
      id: "finance",
      label: "Finance",
      description: "Financial data with complex calculations",
      image: "/images/finance-demo.jpg",
    },
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8">
              <div className="lg:max-w-md">
                ...
                <p className="text-muted-foreground md:text-xl">
                  Experience the performance and flexibility of V-Grid. Try sorting, filtering, and selecting rows in
                  the example below.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:flex-1 lg:max-w-3xl">
                {demos.map((demo) => (
                  <Card
                    ...
                    className={`p-4 cursor-pointer transition-all hover:border-foreground/50 border-2 ${
                      activeDemo === demo.id
                  ...
                  >
                    ...
                    <div
                      className={`font-medium text-sm ${
                        activeDemo === demo.id ? "text-foreground" : "text-muted-foreground"
                      }`}
                    >
                      {demo.label}
                    </div>
